...
class PseudoData(Preprocessing):
	...
	def processing(self, dataset_name):
		...
		data = {"t": t, "msg": msg, "src": src, "dst": dst}

		return data, x


if __name__ == "__main__":
	pseudo = PseudoData(input="raw", output="data", dataset_name="pseudo_data", num_nodes=50, num_edges=1000, node_feat_dim=10, edge_type=10, t=50)
